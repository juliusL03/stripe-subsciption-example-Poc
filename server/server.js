...
app.get("/config", (req, res) => {
  res.send({
    ...
    upfrontPrice: process.env.UPFRONT_PRICE,
    subscriptionPrice: process.env.SUBSCRIPTIONS_PRICE,
  });
});
    ...
    schedule = await stripe.subscriptionSchedules.update(
      schedule.id,
      {
        ...
        phases: [
          ...
          {
            items: [{
              price:  process.env.SUBSCRIPTIONS_PRICE,
              quantity: 1,
            }],
            iterations: 2,
